...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let endpoint = `/api/users/${state}`

            // 👇 FIX: forgot password uses different route
            if (state === "forgot") {
            ...
            // 👇 Only login/register should store token
        ...
        <div className='flex items-center justify-center min-h-screen bg-gray-50'>
            <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
                ...
                <div className="flex items-center mt-4 w-full bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">
                    ...
                    <input type="password" name="password" placeholder={state === "forgot" ? "New Password" : "Password"} className="border-none outline-none ring-0" value={formData.password} onChange={handleChange} required />
                </div>
